...
import { type ProviderSettingsView, toggleRetrievalOverride } from "./provider-form-state";
import {
              ...
              onValueChange={(value) =>
                handleViewChange((current) => ({
                  ...
                  retrievalEmbeddingModel:
                    current.providerProfiles[value as EmbeddingProviderName].embedding_model ?? "",
                }))
              }
